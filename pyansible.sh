  ...
  #python -m pip install --disable-pip-version-check --upgrade --force-reinstall pip==19.3.1
  ...
  python3 -m pip install --disable-pip-version-check --upgrade --force-reinstall ansible==2.9.5
